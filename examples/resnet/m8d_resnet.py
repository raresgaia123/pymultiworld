...
"""
m8d_resnet.py: This script demonstrates how to run a ResNet model on multiple worlds using PyTorch.
...
Sample usage:
    Single host: python m8d_resnet.py --num_workers 1 --backend gloo
    Multi host: python m8d_resnet.py --num_workers 2 --backend nccl --multihost --addr 10.20.1.50 --rank 0
"""
#!/usr/bin/env python
