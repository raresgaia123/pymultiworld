...
This file provides an example of collective communication using all_reduce across multiple worlds.

The example can be executed by opening 5 separate terminal windows to have 5 different processes and running the following commands in each terminal window:
