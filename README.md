...
* [`m8d_send_recv.py`](/examples/send_recv/m8d_send_recv.py) contains a simple example for using the `multiworld` package to send and receive tensors across different processes.
...
python m8d_send_recv.py --backend nccl --worldinfo 1,0 --worldinfo 2,0 --addr 10.20.1.50
# on terminal window 2
python m8d_send_recv.py --backend nccl --worldinfo 1,1 --addr 10.20.1.50
# on terminal window 3
python m8d_send_recv.py --backend nccl --worldinfo 2,1 --addr 10.20.1.50
```
